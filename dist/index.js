(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('http'), require('https'), require('url'), require('stream'), require('assert'), require('tty'), require('util'), require('os'), require('zlib'), require('path'), require('fs')) :
	typeof define === 'function' && define.amd ? define(['http', 'https', 'url', 'stream', 'assert', 'tty', 'util', 'os', 'zlib', 'path', 'fs'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["kms-sdk-node"] = factory(global.require$$1$2, global.require$$2, global.require$$0$2, global.require$$3, global.require$$4, global.require$$1, global.require$$1$1, global.require$$0$1, global.require$$8, global.require$$1$3, global.require$$6));
})(this, (function (require$$1$2, require$$2, require$$0$2, require$$3, require$$4, require$$1, require$$1$1, require$$0$1, require$$8, require$$1$3, require$$6) { 'use strict';
	...
	(function (exports) {
	  ...
	  exports.Request = exports.ApiMethod = void 0;
	  var axios_1 = axios$2.exports;
	  ...
	  (function (ApiMethod) {
	    ...
	    ApiMethod["BatchDelete"] = "batchDelete";
	    ApiMethod["DownloadGet"] = "downloadGet";
	    ...
	    Request.prototype.send = function (apiurl, method, params, config) {
	      return __awaiter(this, void 0, void 0, function () {
	        ...
	        return __generator(this, function (_a) {
	          url = "".concat(this._endPoint).concat(apiurl);

	          switch (method) {
	            case ApiMethod.Get:
	              return [2
	              /*return*/
	              , axios_1["default"].get(url, __assign({
	                params: params
	              }, config))];
	            ...
	            case ApiMethod.Post:
	              return [2
	              /*return*/
	              , axios_1["default"].post(url, params, config)];

	            case ApiMethod.Put:
	              return [2
	              /*return*/
	              , axios_1["default"].put(url, params, config)];

	            case ApiMethod.Patch:
	              return [2
	              /*return*/
	              , axios_1["default"].patch(url, params, config)];

	            case ApiMethod.Delete:
	              return [2
	              /*return*/
	              , axios_1["default"]["delete"](url, params)];
	            ...
	            case ApiMethod.DownloadPost:
	              return [2
	              /*return*/
	              , axios_1["default"].post(url, params, __assign({
	                responseType: 'blob'
	              }, config))];
	...
	function () {
	  ...
	  KmsClient.prototype.add = function () {
	    console.log('add');
	  ...
	  Object.defineProperty(KmsClient.prototype, "config", {
	    get: function get() {
	      return this._config;
	    },
	    enumerable: false,
	  ...
	  KmsClient.prototype._addVersion = function (params) {
	...
	var _default = src$1["default"] = KmsClient;
